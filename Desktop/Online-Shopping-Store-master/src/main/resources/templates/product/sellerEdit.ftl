        ...
        <#--Category-->
            <div class="form-group">
                ...
                <select class="custom-select custom-select-lg " id="categoryType" name="categoryType"
                        required="true">
                    <option value="0">Carosserie</option>
                    <option value="1">Moteur et mecanique</option>
                    <option value="2">Systeme electrique</option>
                    <option value="3">Confort / inferieur</option>
                </select>
            </div>
